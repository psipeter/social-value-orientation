...
agents = [NEF(player=player, nActions=nActions, nGames=nGames, seed=n+1, ID="NEF"+str(n+1),
	update="Q-learning", representation='ssp', radius=0.5,
	nNeuronsState=16000, nStates=160, alpha=1e-8)
